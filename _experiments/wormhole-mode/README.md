...
- `wormhole-preview.html` — isolated preview page using copied/representative Utility sections.
- `wormhole-dark.css` — shared experimental structure plus Signal Dark variables and dark skin rules.
- `wormhole-light.css` — Signal Light variable overrides and light skin adjustments loaded after `wormhole-dark.css`.
- `README.md` — this file.
...
Do not wire this into the live site yet. The next safe step is visual review in `_experiments/signal-mode/wormhole-preview.html`, then a separate integration plan after the Signal skin is approved.
...
- isolated JS copy from `assets/js/protocol.js` into `wormhole-lab.js`
...
- replaced production CSS link with `wormhole-dark.css` and `wormhole-light.css`
- replaced production JS link with isolated `wormhole-lab.js`
