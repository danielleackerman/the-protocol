Here’s the MD block you can keep and design from — compiled from the thread, the uploaded design brief, and the source material.
...
Important: Use a licensed or web-safe font. Do not depend on unknown font files unless licensed.
2. Mono / System Layer
Use for:
	•	command lines
	•	labels
